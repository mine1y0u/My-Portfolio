...
- A short description  
- The tools/languages used  
- Images and videos for showcase and demonstration  
...
- **🧰 Development Tools:** Visual Studio Code (VS Code), Visual Studio 2022, OnlineGDB
...
### 📍[**Learnify Hub — Innovative Interactive Product** *(Collaborative Work)*](https://github.com/name/blank)
...
### 📍 [**Survey System** *(Collaborative Work)*](https://github.com/name/blank)
...
### 📍 [**E-Service Citizen Portal** *(Collaborative Work)*](https://github.com/name/blank)

<p align="justify">A collaborative project for both <b>Web Development</b> and <b>Human Computer Interaction</b> course. It was built using <b>HTML</b>, <b>CSS</b>, and <b>JavaScript</b>, and designed in <b>Figma</b> for mockups and UI planning.</p>
...
### 📍 [**C# Windows Forms: Text Encryptor/Decryptor**](https://github.com/name/blank)
...
### 📍 [**Grade Computation Using Java** *(Collaborative Work)*](https://github.com/name/blank)
...
### 📍 [**Number System Converter Using C++**](https://github.com/name/blank)
...
### 📍 [**Number System Calculator Using C++**](https://github.com/name/blank)
